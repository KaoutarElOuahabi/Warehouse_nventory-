...
switch ($action) {
    case 'correct': {
        ...
        // Assigning a real HU here resolves a former "HU NOT AVAILABLE" line —
        // clear the flag so the comparison engine can match it by HU again.
    ...
    case 'remove': {
        ...
        // Spec 11: never delete the original physical count — soft-delete only,
        // the full record remains visible in the Audit Trail.
        $stmt = $pdo->prepare(
    ...
    case 'confirm_difference': {
        // Controller reviewed and confirms the discrepancy is real; no data changes.
        AuditService::log(
